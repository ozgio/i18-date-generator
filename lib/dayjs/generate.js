...
let generateByLocale = async function(inputDir, locale){
    ...
    let localeData = {
        ...
        weekdaysShort: weekdayKeys.map(e => capitalizeFirst(data.calendars.gregorian.days["stand-alone"]["abbreviated"][e])),
        weekdaysMin: weekdayKeys.map(e => capitalizeFirst(data.calendars.gregorian.days["stand-alone"]["short"][e])),
        months: monthKeys.map(e => capitalizeFirst(data.calendars.gregorian.months["stand-alone"]["wide"][e])),
        monthsShort: monthKeys.map(e => capitalizeFirst(data.calendars.gregorian.months["stand-alone"]["abbreviated"][e])) 
    }
